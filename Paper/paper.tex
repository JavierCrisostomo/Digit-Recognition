...
The weight function is an inverse distance function of the form:
...
data. The faster runtime allowed us to cross validate on the full data set so
our cross validation results are more accurate than those we obtained for KNN.
...
training data set and small number of classes to classify. With only 10 posible
classifications, there are likely around 4,2000 training samples of each
number. The odds of at least a few of those being similar to the test image
...
higher dimension kernel function.
